  ...
  if (!data.length) {
    return (
      <div className="rounded-2xl bg-white p-10 text-center shadow-sm">
        ...
        <h3 className="text-lg font-semibold">Data OLT Kosong</h3>

        <p className="mt-2 text-slate-500">Belum ada OLT yang ditambahkan.</p>
      </div>
    );
  }
            ...
            {data.map((olt, index) => (
              ...
              >
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    <div>
                      <p className="font-semibold">{olt._count.customers}</p>
                    </div>
                  </div>
                </td>
