...
export default function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <div
        onClick={onClose}
        className={`fixed inset-0 z-40 bg-black/40 transition-opacity lg:hidden ${open ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
      />
      ...
      >
        ...
        {/* Menu Container - Menambahkan pb-20 agar menu terbawah tidak tertutup navbar HP */}
        <div className="flex-1 space-y-8 overflow-y-auto p-5 pb-20 lg:pb-5">
